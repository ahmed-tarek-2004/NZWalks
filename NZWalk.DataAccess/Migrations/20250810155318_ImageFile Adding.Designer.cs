...
namespace NZWalk.DataAccess.Migrations
{
    ...
    [Migration("20250810155318_ImageFile Adding")]
    partial class ImageFileAdding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalk.DataAccess.Model.Domin.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NZWalk.DataAccess.Model.Domin.ImageFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalk.DataAccess.Model.Domin.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalk.DataAccess.Model.Domin.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalk.DataAccess.Model.Domin.Walk", b =>
                {
                    b.HasOne("NZWalk.DataAccess.Model.Domin.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId");

                    b.HasOne("NZWalk.DataAccess.Model.Domin.Region", "Region")
                        .WithMany()
